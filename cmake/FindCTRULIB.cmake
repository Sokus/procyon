...
#
# It also adds an imported target named `3ds-ctru`.
# Linking it is the same as target_link_libraries(target ${LIBCTRU_LIBRARIES})
# and target_include_directories(target ${LIBCTRU_INCLUDE_DIRS})
...
if(CTRULIB_FOUND)
    ...
    add_library(3ds-ctru STATIC IMPORTED GLOBAL)
    set_target_properties(3ds-ctru PROPERTIES
